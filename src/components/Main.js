    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>More recently, I have been taking interest in Flutter, and am currently starting work on a Flutter app. I would love to hear a little about the plans Ellipsis Health has for adopting this framework for their products.</p>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>At Ellipsis Health, I hope to work on a development team that pushes each other to make the best possible contributions, being mindful of product roadmaps and what good code looks like and reads like.</p>
          {close}
        </article>
        ...
        <article id="contact" className={`${this.props.article === 'contact' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>I heard about Ellipsis Health from <a href="https://vator.tv/news/2018-04-09-top-10-vcs-investing-in-mental-behavioral-health">Vator.tv</a>, and decided to apply.</p>
