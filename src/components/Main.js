    ...
    return (
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>More recently, I have been taking interest in Flutter, and am currently starting work on a Flutter app.</p>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>At Trello, I hope to work on a development team that pushes each other to make the best possible contributions, being mindful of product roadmaps and what good code looks like and reads like.</p>
          {close}
        </article>
        ...
        <article id="contact" className={`${this.props.article === 'contact' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>I've known about Trello for several years, incorporating it into my workflow, as well as my client work. I'm keen to learn more about some of the challenges facing Trello, especially what the acquisition of <a href="https://blog.trello.com/trello-acquires-butler">Butler</a> means for its future.</p>
